 ...
 * 
 * A função MySAGInsert é responsável por preencher o módulo criado com numeros naturais.
 * 
 * @param N Representa o tamanho do módulo
 * @param stream Representa o módulo
 * 
 ...
 * @param N Representa o tamanho do módulo
 * @param stream Representa o módulo
 * @return Retorna o o valor máximo presente no módulo
 * 
 * @verbatim
   Autor:
 ...
 * @param N Representa o tamanho do módulo
 * @param stream Representa o módulo
 * @return Retorna o o valor mínimo presente no módulo
 * 
 * @verbatim
   Autor:
    * Dário Fernandes, nº93135
